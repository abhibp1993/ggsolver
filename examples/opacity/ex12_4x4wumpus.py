...
-----------------------
Arena is 4x4 grid with no obstacles.
P1 moves freely.
P2 is restricted in 2x2 grid in bottom left.
...
class RndGridworld(opac_models.Arena):
    ...
    def __init__(self, dim, goal_cells, obs=None, actions=None, init_state=None, sense_rng=2):
        ...
        self._dim = dim
        self._p2_walkable = {(r, c) for r in range(0, dim[0] - 2) for c in range(0, dim[1] - 2)}
    ...
    def states(self):
        ...
        p2_rows = range(0, self._dim[0] - 2)
        p2_cols = range(0, self._dim[1] - 2)
