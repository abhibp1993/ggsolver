...
class SimplePG(object):
	...
	def finish_episode(self):
		...
		if std > 0:
			...
			# Avoid division by zero; optionally leave discounted_epr unchanged or set to zeros
			discounted_epr = discounted_epr  # or discounted_epr = np.zeros_like(discounted_epr)
