...
def main():
    ...
    # Log results
    path = os.path.join("out", f"enumerative_trap_results.json")
    ...
    fig.savefig('./out/enumerative_trap_runtime_vs_size.png')
    ...
    fig.savefig('./out/enumerative_trap_vod_vs_size.png')
