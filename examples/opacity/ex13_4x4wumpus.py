...
# Game Parameters
DIM = (5, 5)
GOAL_CELLS = [(3, 0), (4, 4), (0, 4)]
OBS_CELLS = [(1, 2), (3, 3), (4, 2), (4, 3)]
SENSOR_RNG = 1
P2_INIT = (0, 0)
P2_WALKABLE = [
    (3, 0),
...
class RndGridworld(opac_models.Arena):
    ...
    def __init__(self, dim, goal_cells, obs=None, actions=None, init_state=None, sense_rng=2):
        ...
        self._p2_acts = {
            (3, 0): [gw_util.GW_ACT_S],
            (2, 0): [gw_util.GW_ACT_S, gw_util.GW_ACT_N],
            (1, 0): [gw_util.GW_ACT_S, gw_util.GW_ACT_N, gw_util.GW_ACT_E],
            (1, 1): [gw_util.GW_ACT_S, gw_util.GW_ACT_W],
            (1, 3): [gw_util.GW_ACT_S],
            (0, 0): [gw_util.GW_ACT_N, gw_util.GW_ACT_E],
            (0, 1): [gw_util.GW_ACT_E, gw_util.GW_ACT_W, gw_util.GW_ACT_N],
            (0, 2): [gw_util.GW_ACT_E, gw_util.GW_ACT_W],
            (0, 3): [gw_util.GW_ACT_N, gw_util.GW_ACT_W]
        }
